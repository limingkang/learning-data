  ...
  render: function () {
    ...
    return (
      React.createElement("div", React.__spread({},  this.props), 
        ...
        React.createElement("input", {type: "radio", name: "opt", defaultChecked: true}), " Option 1", 
                    React.createElement("input", {type: "radio", name: "opt"}), " Option 2", 
                    React.createElement("select", {defaultValue: "C"}, 
...
ReactDOM.render(React.createElement(Input, {checked: true, name: "world"}), document.getElementById('example'));
